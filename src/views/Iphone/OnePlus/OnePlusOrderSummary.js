...
import OneplusMobile from '../../../assets/images/homepage/one-plush-black.png'
import { Link, useLocation, useNavigate } from 'react-router-dom'
import { FaArrowLeftLong } from "react-icons/fa6";
import { Helmet } from 'react-helmet';
import { Button } from 'reactstrap';

const OnePlusOrderSummary = () => {
                        ...
                        <ul class="list-group list-group-flush" id="deals">
                            <li class="list-group-item px-0" data-timer="2000">
                                <div class="flex recommended-product">
                                    <img src={OneplusMobile} alt='Iphone'
                                        id="item_image" width="200px" />
                                    <div class="description">
                                        <div class="product-title mb-1" id="product-title">OnePlus 10R 5G Prime Black 128GB</div>
                                        <div class="product-detail mb-1" id="product-detail">Black</div>
                                ...
                                <div class="flex recommended-product mt-3">
                                    <div class="description">
                                        <div class="price d-flex">
                                            ...
                                            &nbsp;&nbsp;
                                            <span class="selling_price" id="selling_price">₹ 699</span>
                                        </div>
                                    </div>
                                </div>
                            </li>
                    ...
                    <div class="card mt-3 p-3 mb-3" id="price-detail">
                        ...
                        <div class="price-detail-div mt-2">
                            <div class="my-3 d-flex justify-content-between">
                                ...
                                <span class="text-success">₹ 699</span>
                            </div>
                            <div class="my-3 d-flex justify-content-between">
                            ...
                            <div class="my-3 pt-3 d-flex justify-content-between total">
                                ...
                                <span class="data selling_price">₹ 699</span>
                            </div>
                            <div class="product-price-list mt-3 pt-3 saved-div">
                                <span class="text-success">You will save <span class="discount-amt">-₹699</span> on this
                                    order</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row p-2">
                            ...
                            <div class="col">
                                <form >
                                    ...
                                    <button onClick={()=> navigate("/oneplus-mobile-payment-details")} type="submit" class="btn bg-warning" >Continue</button>
                                </form>
                            </div>
                        </div>
                    </div>
...
export default OnePlusOrderSummary
