...
const JblEarbudProductDetail = () => {
  ...
  return (
    <>
      ...
      />
      <JblEarbudProductDetails />
      <Footer
      AddLink="/jbl-earbud-delivery-address"
      BuyLink="/jbl-earbud-delivery-address"
       />
      </div>
    </>
  )
...
export default JblEarbudProductDetail
