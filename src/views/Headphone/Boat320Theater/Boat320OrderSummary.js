                            ...
                            <li class="list-group-item px-0" data-timer="2000">
                                <div class="flex recommended-product">
                                    ...
                                    <div class="description">
                                        <div class="product-title mb-1" id="product-title">boAt Aavante Bar 320...  Black</div>
                        ...
                        <div class="row p-2">
                            ...
                            <div class="col">
                                <form >
                                    ...
                                    <button onClick={()=> navigate("/boat-320-payment-details")} type="submit" class="btn bg-warning" >Continue</button>
                                </form>
                            </div>
                        </div>
                    </div>
...
export default Boat320OrderSummary
