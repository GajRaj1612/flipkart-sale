...
import SonyHeadPhoneProductDetails from '../../../components/pages/Iphone/SonyHeadPhoneProductDetails/SonyHeadPhoneProductDetails';
...
const HeadphoneProductDetails = () => {
  ...
  return (
    <>
      ...
      />
      <SonyHeadPhoneProductDetails />
      <Footer
      AddLink="/sony-headphone-delivery-address"
      BuyLink="/sony-headphone-delivery-address"
       />
      </div>
    </>
  )
