...
import WingHeadphone from '../../../assets/images/homepage/earbud-light.jpg'
import { Link, useLocation, useNavigate } from 'react-router-dom'
import { FaArrowLeftLong } from "react-icons/fa6";
import { Helmet } from 'react-helmet';
import { Button } from 'reactstrap';

const WingsEarbudOrderSummary = () => {
                        ...
                        <ul class="list-group list-group-flush" id="deals">
                            <li class="list-group-item px-0" data-timer="2000">
                                <div class="flex recommended-product">
                                    <img src={WingHeadphone} alt='Iphone'
                                        id="item_image" width="200px" />
                                    <div class="description">
                                        <div class="product-title mb-1" id="product-title">Wings Phantom 340 Be...  Black</div>
                    ...
                    <div class="card mt-3 p-3 mb-3" id="price-detail">
                        ...
                        <div class="price-detail-div mt-2">
                            ...
                            <div class="my-3 pt-3 d-flex justify-content-between total">
                                ...
                                <span class="data selling_price">₹ 299</span>
                            </div>
                            <div class="product-price-list mt-3 pt-3 saved-div">
                                <span class="text-success">You will save <span class="discount-amt">-₹299</span> on this
                                    order</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row p-2">
                            ...
                            <div class="col">
                                <form >
                                    ...
                                    <button onClick={()=> navigate("/wings-earbud-payment-details")} type="submit" class="btn bg-warning" >Continue</button>
                                </form>
                            </div>
                        </div>
                    </div>
...
export default WingsEarbudOrderSummary
