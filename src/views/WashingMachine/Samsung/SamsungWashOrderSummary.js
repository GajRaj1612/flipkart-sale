...
import SamsungWashingMachine from '../../../assets/images/homepage/wash-machin.jpg'
import { Link, useLocation, useNavigate } from 'react-router-dom'
import { FaArrowLeftLong } from "react-icons/fa6";
import { Helmet } from 'react-helmet';
import { Button } from 'reactstrap';

const SamsungWashOrderSummary = () => {
                        ...
                        <ul class="list-group list-group-flush" id="deals">
                            <li class="list-group-item px-0" data-timer="2000">
                                <div class="flex recommended-product">
                                    <img src={SamsungWashingMachine} alt='Iphone'
                                        id="item_image" width="200px" />
                                    <div class="description">
                                        <div class="product-title mb-1" id="product-title">IFB 9 Kg 5 Star Fron...  Mocha O2 Bubble Wash</div>
                                        <div class="product-detail mb-1" id="product-detail">White</div>
                                        <img loading="eager" class="_396cs4 _2amPTt _3qGmMb"
                                            alt="APPLE iPhone 14 ((PRODUCT)RED, 128 GB)"
                                            src={SamsungWashingMachine}
                                            width="77px" />
                                    </div>
                                </div>
                                <div class="flex recommended-product mt-3">
                                    <div class="description">
                                        <div class="price d-flex">
                                            ...
                                            &nbsp;&nbsp;
                                            <span><del> ₹ 67800</del></span>
                                            &nbsp;&nbsp;
                                            <span class="selling_price" id="selling_price">₹ 649</span>
                                        </div>
                                    </div>
                                </div>
                            </li>
                    ...
                    <div class="card mt-3 p-3 mb-3" id="price-detail">
                        ...
                        <div class="price-detail-div mt-2">
                            <div class="my-3 d-flex justify-content-between">
                                ...
                                <span class="text-success">₹ 649</span>
                            </div>
                            <div class="my-3 d-flex justify-content-between">
                            ...
                            <div class="my-3 pt-3 d-flex justify-content-between total">
                                ...
                                <span class="data selling_price">₹ 649</span>
                            </div>
                            <div class="product-price-list mt-3 pt-3 saved-div">
                                <span class="text-success">You will save <span class="discount-amt">-₹649</span> on this
                                    order</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row p-2">
                            ...
                            <div class="col">
                                <form >
                                    ...
                                    <button onClick={()=> navigate("/washing-machine-payment-details")} type="submit" class="btn bg-warning" >Continue</button>
                                </form>
                            </div>
                        </div>
                    </div>
...
export default SamsungWashOrderSummary
