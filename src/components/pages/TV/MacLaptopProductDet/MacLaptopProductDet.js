...
import './MacLaptopProductDet.scss'
...
import MackBook from '../../../../assets/images/product-details/laptop.jpg'
...
import Laptop1 from '../../../../assets/images/product-details/mac.jpg'
import Laptop2 from '../../../../assets/images/product-details/mac_1.jpg'
import Laptop3 from '../../../../assets/images/product-details/mac_2.jpg'
import { Link } from 'react-router-dom'

const MacLaptopProductDet = () => {
                            ...
                            <Col className='col-lg-4 col-md-6 col-sm-6'>
                                ...
                                >
                                    <div className='big-img-slider'>
                                        <img src={MackBook} alt="Iphone" height={450} width={"100%"} />
                                    </div>
                            ...
                            <Col>
                                ...
                                >
                                    <div className='small-img'>
                                        <img src={MackBook} alt="Iphone" width={40} />
                                    </div>
            ...
            <div className="product-select">
                <Container>
                    <Row className='product-des'>
                        <Col >
                            <div className='card'>
                                <div class="product-title"> Apple 2022 MacBook A...  Default</div>
                                <img src={Assured} alt="Assured" className='my-2' width={100} />
                                <p class="text-success des">
                                    <b>2% off</b>
                                    <del class="text-dark"> ₹ 99000</del>
            ...
            <div className="product-det">
                <Container>
                    ...
                    <div className="img-container card">
                        <img className='mb-sm-5 mb-3' src={Laptop1} alt="Ahuge" />
                        <img className='mb-sm-5 mb-3' src={Laptop2} alt="Water" />
                        <img className='mb-sm-5 mb-3' src={Laptop3} alt="Water" />
                    </div>
                </Container>
            </div>
...
export default MacLaptopProductDet