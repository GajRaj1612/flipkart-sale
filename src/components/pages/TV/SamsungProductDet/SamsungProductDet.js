...
import SamsungLed from '../../../../assets/images/product-details/led-tv.jpg'
...
import LedTv1 from '../../../../assets/images/product-details/samtv.jpg'
import LedTv2 from '../../../../assets/images/product-details/samtv_1.jpg'
import { Link } from 'react-router-dom'

const SamsungProductDet = () => {
                            ...
                            <Col className='col-lg-4 col-md-6 col-sm-6'>
                                ...
                                >
                                    <div className='big-img-slider'>
                                        <img src={SamsungLed} alt="Iphone" height={450} width={"100%"} />
                                    </div>
                            ...
                            <Col>
                                ...
                                >
                                    <div className='small-img'>
                                        <img src={SamsungLed} alt="Iphone" width={40} />
                                    </div>
            ...
            <div className="product-select">
                <Container>
                    <Row className='product-des'>
                        <Col >
                            <div className='card'>
                                <div class="product-title"> Samsung 138 cm (55 i...    43 In)</div>
                                <img src={Assured} alt="Assured" className='my-2' width={100} />
                                <p class="text-success des">
                                    <b>2% off</b>
                                    <del class="text-dark"> ₹ 32000</del>
...
export default SamsungProductDet