...
import MagPowerBank from '../../../../assets/images/product-details/power-bank.jpg'
...
import PowerBank1 from '../../../../assets/images/product-details/mag.jpeg'
import PowerBank2 from '../../../../assets/images/product-details/mag_1.jpeg'
import PowerBank3 from '../../../../assets/images/product-details/mag_2.jpeg'
import PowerBank4 from '../../../../assets/images/product-details/mag_3.jpeg'
import { Link } from 'react-router-dom'

const MagBankProductDet = () => {
                            ...
                            <Col className='col-lg-4 col-md-6 col-sm-6'>
                                ...
                                >
                                    <div className='big-img-slider'>
                                        <img src={MagPowerBank} alt="Iphone" height={450} width={"100%"} />
                                    </div>
                            ...
                            <Col>
                                ...
                                >
                                    <div className='small-img'>
                                        <img src={MagPowerBank} alt="Iphone" width={40} />
                                    </div>
            ...
            <div className="product-select">
                <Container>
                    <Row className='product-des'>
                        <Col >
                            <div className='card'>
                                <div class="product-title"> 2&CO 10000mAh MagSaf...  Default</div>
                                <img src={Assured} alt="Assured" className='my-2' width={100} />
                                <p class="text-success des">
                                    <b>2% off</b>
                                    <del class="text-dark"> ₹ 12000</del>
            ...
            <div className="product-det">
                <Container>
                    ...
                    <div className="img-container card">
                        <img className='mb-sm-5 mb-3' src={PowerBank1} alt="Ahuge" />
                        <img className='mb-sm-5 mb-3' src={PowerBank2} alt="Water" />
                        <img className='mb-sm-5 mb-3' src={PowerBank3} alt="WonderFull" />
                        <img className='mb-sm-5 mb-3' src={PowerBank4} alt="Crash" />
                    </div>
                </Container>
            </div>
...
export default MagBankProductDet