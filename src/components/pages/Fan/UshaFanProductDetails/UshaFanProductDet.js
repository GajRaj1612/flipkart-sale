...
import UshaFan from '../../../../assets/images/product-details/fun-white.jpg'
...
import UshaFan1 from '../../../../assets/images/product-details/usha.jpg'
import UshaFan2 from '../../../../assets/images/product-details/usha_1.jpg'
import UshaFan3 from '../../../../assets/images/product-details/usha_2.jpg'
import UshaFan4 from '../../../../assets/images/product-details/usha_3.jpg'
import { Link } from 'react-router-dom'

const UshaFanProductDet = () => {
                            ...
                            <Col className='col-lg-4 col-md-6 col-sm-6'>
                                ...
                                >
                                    <div className='big-img-slider'>
                                        <img src={UshaFan} alt="Iphone" height={450} width={"100%"} />
                                    </div>
                            ...
                            <Col>
                                ...
                                >
                                    <div className='small-img'>
                                        <img src={UshaFan} alt="Iphone" width={40} />
                                    </div>
            ...
            <div className="product-select">
                <Container>
                    <Row className='product-des'>
                        <Col >
                            <div className='card'>
                                <div class="product-title"> Usha Bloom Daffodil ...  Golden & Brown</div>
                                <img src={Assured} alt="Assured" className='my-2' width={100} />
                                <p class="text-success des">
                                    <b>2% off</b>
                                    <del class="text-dark"> ₹ 7800</del>
            ...
            <div className="product-det">
                <Container>
                    ...
                    <div className="img-container card">
                        <img className='mb-sm-5 mb-3' src={UshaFan1} alt="WonderFull" />
                        <img className='mb-sm-5 mb-3' src={UshaFan2} alt="Ahuge" />
                        <img className='mb-sm-5 mb-3' src={UshaFan3} alt="Water" />
                        <img className='mb-sm-5 mb-3' src={UshaFan4} alt="Crash" />
                    </div>
                </Container>
            </div>
...
export default UshaFanProductDet