...
import './AppleWatchProductDet.scss'
...
import AppleWatch from '../../../../assets/images/product-details/smart-watch-orange.jpeg'
...
import Watch1 from '../../../../assets/images/product-details/applewatch.jpeg'
import Watch2 from '../../../../assets/images/product-details/applewatch_1.jpg'
import { Link } from 'react-router-dom'

const AppleWatchProductDet = () => {
                            ...
                            <Col className='col-lg-4 col-md-6 col-sm-6'>
                                ...
                                >
                                    <div className='big-img-slider'>
                                        <img src={AppleWatch} alt="Iphone" height={450} width={"100%"} />
                                    </div>
                            ...
                            <Col>
                                ...
                                >
                                    <div className='small-img'>
                                        <img src={AppleWatch} alt="Iphone" width={40} />
                                    </div>
            ...
            <div className="product-select">
                <Container>
                    <Row className='product-des'>
                        <Col >
                            <div className='card'>
                                <div class="product-title"> Apple Watch Ultra GP...  Star Light</div>
                                <img src={Assured} alt="Assured" className='my-2' width={100} />
                                <p class="text-success des">
                                    <b>2% off</b>
                                    <del class="text-dark"> ₹ 89900</del>
                                    <span class="text-dark"> ₹ 899</span>
                                </p>
                            </div>
                        </Col>
                    </Row>
...
export default AppleWatchProductDet