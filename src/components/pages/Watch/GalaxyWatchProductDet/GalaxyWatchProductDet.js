...
import './GalaxyWatchProductDet.scss'
...
import GalaxyWatch from '../../../../assets/images/product-details/smart-watch.webp'
...
import Watch1 from '../../../../assets/images/product-details/galaxywatch.jpg'
import Watch2 from '../../../../assets/images/product-details/galaxywatch_1.jpg'
import Watch3 from '../../../../assets/images/product-details/galaxywatch_2.jpg'
import Watch4 from '../../../../assets/images/product-details/galaxywatch_3.jpg'
import { Link } from 'react-router-dom'

const GalaxyWatchProductDet = () => {
                            ...
                            <Col className='col-lg-4 col-md-6 col-sm-6'>
                                ...
                                >
                                    <div className='big-img-slider'>
                                        <img src={GalaxyWatch} alt="Iphone" height={450} width={"100%"} />
                                    </div>
                            ...
                            <Col>
                                ...
                                >
                                    <div className='small-img'>
                                        <img src={GalaxyWatch} alt="Iphone" width={40} />
                                    </div>
            ...
            <div className="product-select">
                <Container>
                    <Row className='product-des'>
                        <Col >
                            <div className='card'>
                                <div class="product-title"> Galaxy Watch6 LTE, ...  Graphite</div>
                                <img src={Assured} alt="Assured" className='my-2' width={100} />
                                <p class="text-success des">
                                    <b>2% off</b>
                                    <del class="text-dark"> ₹ 36999</del>
                                    <span class="text-dark"> ₹ 599</span>
                                </p>
                            </div>
                        </Col>
                    </Row>
            ...
            <div className="product-det">
                <Container>
                    ...
                    <div className="img-container card">
                        <img className='mb-sm-5 mb-3' src={Watch1} alt="Ahuge" />
                        <img className='mb-sm-5 mb-3' src={Watch2} alt="Water" />
                        <img className='mb-sm-5 mb-3' src={Watch3} alt="Water" />
                        <img className='mb-sm-5 mb-3' src={Watch4} alt="Water" />
                    </div>
                </Container>
            </div>
...
export default GalaxyWatchProductDet