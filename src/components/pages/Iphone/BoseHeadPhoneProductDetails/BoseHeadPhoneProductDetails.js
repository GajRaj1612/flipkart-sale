...
import './BoseHeadPhoneProductDetails.scss'
...
import BoseHeadphone from '../../../../assets/images/product-details/headphone-white.png'
...
import Bose1 from '../../../../assets/images/product-details/bose.jpg'
import Bose2 from '../../../../assets/images/product-details/bose_2.jpg'
import Bose3 from '../../../../assets/images/product-details/bose_1.jpg'
import Bose4 from '../../../../assets/images/product-details/bose_4.jpg'
import { Link } from 'react-router-dom'

const BoseHeadPhoneProductDetails = () => {
                            ...
                            <Col className='col-lg-4 col-md-6 col-sm-6'>
                                ...
                                >
                                    <div className='big-img-slider'>
                                        <img src={BoseHeadphone} alt="Iphone" height={450} width={"100%"} />
                                    </div>
                            ...
                            <Col>
                                ...
                                >
                                    <div className='small-img'>
                                        <img src={BoseHeadphone} alt="Iphone" width={40} />
                                    </div>
            ...
            <div className="product-select">
                <Container>
                    <Row className='product-des'>
                        <Col >
                            <div className='card'>
                                <div class="product-title"> Bose Quietcomfort 45...  Eclipse White</div>
                                <img src={Assured} alt="Assured" className='my-2' width={100} />
                                <p class="text-success des">
                                    <b>2% off</b>
                                    <del class="text-dark"> ₹ 9000</del>
                                    <span class="text-dark"> ₹ 399</span>
                                </p>
                            </div>
                        </Col>
                    </Row>
            ...
            <div className="product-det">
                <Container>
                    ...
                    <div className="img-container card">
                        <img className='mb-sm-5 mb-3' src={Bose1} alt="WonderFull" />
                        <img className='mb-sm-5 mb-3' src={Bose2} alt="Ahuge" />
                        <img className='mb-sm-5 mb-3' src={Bose3} alt="Water" />
                        <img className='mb-sm-5 mb-3' src={Bose4} alt="Crash" />
                    </div>
                </Container>
            </div>
...
export default BoseHeadPhoneProductDetails