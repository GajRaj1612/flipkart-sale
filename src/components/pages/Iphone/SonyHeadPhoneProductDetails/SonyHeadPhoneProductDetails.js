...
import './SonyHeadPhoneProductDetails.scss'
...
import SonyHeadphone from '../../../../assets/images/product-details/headphone-gyre.jpg'
...
import Sony1 from '../../../../assets/images/product-details/sony_1.jpg'
import Sony2 from '../../../../assets/images/product-details/sony_2.jpg'
import Sony3 from '../../../../assets/images/product-details/sony.jpg'
import Sony4 from '../../../../assets/images/product-details/sony_3.jpg'
import { Link } from 'react-router-dom'

const SonyHeadPhoneProductDetails = () => {
                            ...
                            <Col className='col-lg-4 col-md-6 col-sm-6'>
                                ...
                                >
                                    <div className='big-img-slider'>
                                        <img src={SonyHeadphone} alt="Iphone" height={450} width={"100%"} />
                                    </div>
                            ...
                            <Col>
                                ...
                                >
                                    <div className='small-img'>
                                        <img src={SonyHeadphone} alt="Iphone" width={40} />
                                    </div>
            ...
            <div className="product-select">
                <Container>
                    <Row className='product-des'>
                        <Col >
                            <div className='card'>
                                <div class="product-title"> Sony WH-1000XM4 Indu...  Blue</div>
                                <img src={Assured} alt="Assured" className='my-2' width={100} />
                                <p class="text-success des">
                                    <b>2% off</b>
                                    <del class="text-dark"> ₹ 6500</del>
                                    <span class="text-dark"> ₹ 349</span>
                                </p>
                            </div>
                        </Col>
                    </Row>
            ...
            <div className="product-det">
                <Container>
                    ...
                    <div className="img-container card">
                        <img className='mb-sm-5 mb-3' src={Sony1} alt="WonderFull" />
                        <img className='mb-sm-5 mb-3' src={Sony2} alt="Ahuge" />
                        <img className='mb-sm-5 mb-3' src={Sony3} alt="Water" />
                        <img className='mb-sm-5 mb-3' src={Sony4} alt="Crash" />
                    </div>
                </Container>
            </div>
...
export default SonyHeadPhoneProductDetails