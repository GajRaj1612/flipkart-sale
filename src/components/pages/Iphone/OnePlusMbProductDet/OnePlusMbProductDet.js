...
import './OnePlusMbProductDet.scss'
...
import OnePlusMobile from '../../../../assets/images/product-details/one-plush-black.png'
...
import Mobile1 from '../../../../assets/images/product-details/oneplusmb.jpeg'
import Mobile2 from '../../../../assets/images/product-details/oneplusmb_1.jpeg'
import Mobile3 from '../../../../assets/images/product-details/oneplusmb_2.jpeg'
import Mobile4 from '../../../../assets/images/product-details/oneplusmb_3.jpeg'
import { Link } from 'react-router-dom'

const OnePlusMbProductDet = () => {
                            ...
                            <Col className='col-lg-4 col-md-6 col-sm-6'>
                                ...
                                >
                                    <div className='big-img-slider'>
                                        <img src={OnePlusMobile} alt="Iphone" height={450} width={"100%"} />
                                    </div>
                            ...
                            <Col>
                                ...
                                >
                                    <div className='small-img'>
                                        <img src={OnePlusMobile} alt="Iphone" width={40} />
                                    </div>
            ...
            <div className="product-select">
                <Container>
                    <Row className='product-des'>
                        <Col >
                            <div className='card'>
                                <div class="product-title"> OnePlus 10R 5G Prime Black 128GB</div>
            ...
            <div className="product-det">
                <Container>
                    ...
                    <div className="img-container card">
                        ...
                        <img className='mb-sm-5 mb-3' src={Mobile2} alt="WonderFull" />
                        <img className='mb-sm-5 mb-3' src={Mobile3} alt="WonderFull" />
                        <img className='mb-sm-5 mb-3' src={Mobile4} alt="Ahuge" />
                    </div>
                </Container>
            </div>
...
export default OnePlusMbProductDet