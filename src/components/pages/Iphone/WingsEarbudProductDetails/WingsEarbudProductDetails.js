...
import './WingsEarbudProductDetails.scss'
...
import WingsEarbud from '../../../../assets/images/product-details/earbud-light.jpg'
...
import Wings1 from '../../../../assets/images/product-details/wings.jpg'
import Wings2 from '../../../../assets/images/product-details/wings_1.jpg'
import Wings3 from '../../../../assets/images/product-details/wings_2.jpg'
import Wings4 from '../../../../assets/images/product-details/wings_3.jpg'
import { Link } from 'react-router-dom'

const WingsEarbudProductDetails = () => {
                            ...
                            <Col className='col-lg-4 col-md-6 col-sm-6'>
                                ...
                                >
                                    <div className='big-img-slider'>
                                        <img src={WingsEarbud} alt="Iphone" height={450} width={"100%"} />
                                    </div>
                            ...
                            <Col>
                                ...
                                >
                                    <div className='small-img'>
                                        <img src={WingsEarbud} alt="Iphone" width={40} />
                                    </div>
            ...
            <div className="product-select">
                <Container>
                    <Row className='product-des'>
                        <Col >
                            <div className='card'>
                                <div class="product-title"> Wings Phantom 340 Be...  Black</div>
                                <img src={Assured} alt="Assured" className='my-2' width={100} />
                                <p class="text-success des">
                                    <b>2% off</b>
                                    <del class="text-dark"> ₹ 3400</del>
                                    <span class="text-dark"> ₹ 299</span>
                                </p>
                            </div>
                        </Col>
                    </Row>
            ...
            <div className="product-det">
                <Container>
                    ...
                    <div className="img-container card">
                        <img className='mb-sm-5 mb-3' src={Wings1} alt="WonderFull" />
                        <img className='mb-sm-5 mb-3' src={Wings2} alt="Ahuge" />
                        <img className='mb-sm-5 mb-3' src={Wings3} alt="Water" />
                        <img className='mb-sm-5 mb-3' src={Wings4} alt="Crash" />
                    </div>
                </Container>
            </div>
...
export default WingsEarbudProductDetails