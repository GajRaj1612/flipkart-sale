...
import './JblEarbudProductDetails.scss'
...
import JblEarbud from '../../../../assets/images/product-details/earbud.jpg'
...
import Jbl1 from '../../../../assets/images/product-details/jbl.jpg'
import Jbl2 from '../../../../assets/images/product-details/jbl_1.jpg'
import Jbl3 from '../../../../assets/images/product-details/jbl_2.jpg'
import Jbl4 from '../../../../assets/images/product-details/jbl_3.jpg'
import { Link } from 'react-router-dom'

const JblEarbudProductDetails = () => {
                            ...
                            <Col className='col-lg-4 col-md-6 col-sm-6'>
                                ...
                                >
                                    <div className='big-img-slider'>
                                        <img src={JblEarbud} alt="Iphone" height={450} width={"100%"} />
                                    </div>
                            ...
                            <Col>
                                ...
                                >
                                    <div className='small-img'>
                                        <img src={JblEarbud} alt="Iphone" width={40} />
                                    </div>
            ...
            <div className="product-select">
                <Container>
                    <Row className='product-des'>
                        <Col >
                            <div className='card'>
                                <div class="product-title"> JBL Tune Beam Wirele...  Black</div>
                                <img src={Assured} alt="Assured" className='my-2' width={100} />
                                <p class="text-success des">
                                    <b>2% off</b>
                                    <del class="text-dark"> ₹ 6000</del>
            ...
            <div className="product-det">
                <Container>
                    ...
                    <div className="img-container card">
                        <img className='mb-sm-5 mb-3' src={Jbl1} alt="WonderFull" />
                        <img className='mb-sm-5 mb-3' src={Jbl2} alt="Ahuge" />
                        <img className='mb-sm-5 mb-3' src={Jbl3} alt="Water" />
                        <img className='mb-sm-5 mb-3' src={Jbl4} alt="Crash" />
                    </div>
                </Container>
            </div>
...
export default JblEarbudProductDetails