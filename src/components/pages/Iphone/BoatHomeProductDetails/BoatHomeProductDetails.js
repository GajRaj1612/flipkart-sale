...
import './BoatHomeProductDetails.scss'
...
import BoatHome from '../../../../assets/images/product-details/music-set.png'
...
import Boat1 from '../../../../assets/images/product-details/boat315.jpeg'
import Boat2 from '../../../../assets/images/product-details/boat315_1.jpeg'
import Boat3 from '../../../../assets/images/product-details/boat315_2.jpeg'
import Boat4 from '../../../../assets/images/product-details/boat315_3.jpeg'
import { Link } from 'react-router-dom'

const BoatHomeProductDetails = () => {
                            ...
                            <Col className='col-lg-4 col-md-6 col-sm-6'>
                                ...
                                >
                                    <div className='big-img-slider'>
                                        <img src={BoatHome} alt="Iphone" height={450} width={"100%"} />
                                    </div>
                            ...
                            <Col>
                                ...
                                >
                                    <div className='small-img'>
                                        <img src={BoatHome} alt="Iphone" width={40} />
                                    </div>
            ...
            <div className="product-select">
                <Container>
                    <Row className='product-des'>
                        <Col >
                            <div className='card'>
                                <div class="product-title"> boAt Aavante 3150D |...  Black</div>
                                <img src={Assured} alt="Assured" className='my-2' width={100} />
                                <p class="text-success des">
                                    <b>2% off</b>
                                    <del class="text-dark"> ₹ 39990</del>
            ...
            <div className="product-det">
                <Container>
                    ...
                    <div className="img-container card">
                        <img className='mb-sm-5 mb-3' src={Boat1} alt="WonderFull" />
                        <img className='mb-sm-5 mb-3' src={Boat2} alt="Ahuge" />
                        <img className='mb-sm-5 mb-3' src={Boat3} alt="Water" />
                        <img className='mb-sm-5 mb-3' src={Boat4} alt="Crash" />
                    </div>
                </Container>
            </div>
...
export default BoatHomeProductDetails