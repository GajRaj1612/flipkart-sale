...
import './GalaxyFlipProductDet.scss'
...
import GalaxyFlip from '../../../../assets/images/product-details/product-color-mint.webp'
...
import mobile1 from '../../../../assets/images/product-details/galaxyflip.jpg'
import mobile2 from '../../../../assets/images/product-details/galaxyflip_1.jpg'
import mobile3 from '../../../../assets/images/product-details/galaxyflip_2.jpg'
import mobile4 from '../../../../assets/images/product-details/galaxyflip_3.jpg'
import { Link } from 'react-router-dom'

const GalaxyFlipProductDet = () => {
                            ...
                            <Col className='col-lg-4 col-md-6 col-sm-6'>
                                ...
                                >
                                    <div className='big-img-slider'>
                                        <img src={GalaxyFlip} alt="Iphone" height={450} width={"100%"} />
                                    </div>
                            ...
                            <Col>
                                ...
                                >
                                    <div className='small-img'>
                                        <img src={GalaxyFlip} alt="Iphone" width={40} />
                                    </div>
            ...
            <div className="product-select">
                <Container>
                    <Row className='product-des'>
                        <Col >
                            <div className='card'>
                                <div class="product-title"> SGalaxy Z Flip5 Mint 256GB</div>
                                <img src={Assured} alt="Assured" className='my-2' width={100} />
                                <p class="text-success des">
                                    <b>2% off</b>
                                    <del class="text-dark"> ₹ 19999</del>
                                    <span class="text-dark"> ₹ 1299</span>
                                </p>
                            </div>
                        </Col>
                    </Row>
            ...
            <div className="product-det">
                <Container>
                    ...
                    <div className="img-container card">
                        <img className='mb-sm-5 mb-3' src={mobile1} alt="WonderFull" />
                        <img className='mb-sm-5 mb-3' src={mobile2} alt="Ahuge" />
                        <img className='mb-sm-5 mb-3' src={mobile3} alt="Water" />
                        <img className='mb-sm-5 mb-3' src={mobile4} alt="Crash" />
                    </div>
                </Container>
            </div>
...
export default GalaxyFlipProductDet