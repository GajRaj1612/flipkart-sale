...
import './SamsungFridgeProductDet.scss'
...
import SamsungFridge from '../../../../assets/images/product-details/fridgehome.jpg'
...
import Fridge1 from '../../../../assets/images/product-details/fridge.jpg'
import Fridge2 from '../../../../assets/images/product-details/fridge_1.jpg'
import { Link } from 'react-router-dom'

const SamsungFridgeProductDet = () => {
                            ...
                            <Col className='col-lg-4 col-md-6 col-sm-6'>
                                ...
                                >
                                    <div className='big-img-slider'>
                                        <img src={SamsungFridge} alt="Iphone" height={450} width={"100%"} />
                                    </div>
                            ...
                            <Col>
                                ...
                                >
                                    <div className='small-img'>
                                        <img src={SamsungFridge} alt="Iphone" width={40} />
                                    </div>
            ...
            <div className="product-select">
                <Container>
                    <Row className='product-des'>
                        <Col >
                            <div className='card'>
                                <div class="product-title"> Samsung 336 L 3 Star...  2023 3 Star Silver</div>
                                <img src={Assured} alt="Assured" className='my-2' width={100} />
                                <p class="text-success des">
                                    <b>2% off</b>
                                    <del class="text-dark"> ₹ 34000</del>
            ...
            <div className="product-det">
                <Container>
                    ...
                    <div className="img-container card">
                        <img className='mb-sm-5 mb-3' src={Fridge1} alt="WonderFull" />
                        <img className='mb-sm-5 mb-3' src={Fridge2} alt="Ahuge" />
                    </div>
                </Container>
            </div>
...
export default SamsungFridgeProductDet