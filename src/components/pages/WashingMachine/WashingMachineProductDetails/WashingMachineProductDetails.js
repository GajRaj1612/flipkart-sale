...
import './WashingMachineProductDetails.scss'
...
import WashingMachine from '../../../../assets/images/product-details/wash-machin.jpg'
...
import IFB1 from '../../../../assets/images/product-details/ifb.jpg'
import IFB2 from '../../../../assets/images/product-details/ifb_3.jpg'
import IFB3 from '../../../../assets/images/product-details/ifb_1.jpg'
import IFB4 from '../../../../assets/images/product-details/ifb_4.jpg'
import { Link } from 'react-router-dom'

const WashingMachineProductDetails = () => {
                            ...
                            <Col className='col-lg-4 col-md-6 col-sm-6'>
                                ...
                                >
                                    <div className='big-img-slider'>
                                        <img src={WashingMachine} alt="Iphone" height={450} width={"100%"} />
                                    </div>
                            ...
                            <Col>
                                ...
                                >
                                    <div className='small-img'>
                                        <img src={WashingMachine} alt="Iphone" width={40} />
                                    </div>
            ...
            <div className="product-select">
                <Container>
                    <Row className='product-des'>
                        <Col >
                            <div className='card'>
                                <div class="product-title"> IFB 9 Kg 5 Star Fron...  Mocha O2 Bubble Wash</div>
                                <img src={Assured} alt="Assured" className='my-2' width={100} />
                                <p class="text-success des">
                                    <b>2% off</b>
                                    <del class="text-dark"> ₹ 67800</del>
                                    <span class="text-dark"> ₹ 649</span>
                                </p>
                            </div>
                        </Col>
                    </Row>
            ...
            <div className="product-det">
                <Container>
                    ...
                    <div className="img-container card">
                        <img className='mb-sm-5 mb-3' src={IFB1} alt="WonderFull" />
                        <img className='mb-sm-5 mb-3' src={IFB2} alt="Ahuge" />
                        <img className='mb-sm-5 mb-3' src={IFB3} alt="Water" />
                        <img className='mb-sm-5 mb-3' src={IFB4} alt="Crash" />
                    </div>
                </Container>
            </div>
...
export default WashingMachineProductDetails