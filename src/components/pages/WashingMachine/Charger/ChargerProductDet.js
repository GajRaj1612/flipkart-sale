...
import MobileCharger from '../../../../assets/images/product-details/charger-cabal.jpg'
...
import Charger from '../../../../assets/images/product-details/charger.jpg'
import { Link } from 'react-router-dom'

const ChargerProductDet = () => {
                            ...
                            <Col className='col-lg-4 col-md-6 col-sm-6'>
                                ...
                                >
                                    <div className='big-img-slider'>
                                        <img src={MobileCharger} alt="Iphone" height={450} width={"100%"} />
                                    </div>
                            ...
                            <Col>
                                ...
                                >
                                    <div className='small-img'>
                                        <img src={MobileCharger} alt="Iphone" width={40} />
                                    </div>
            ...
            <div className="product-select">
                <Container>
                    <Row className='product-des'>
                        <Col >
                            <div className='card'>
                                <div class="product-title"> Samsung Original 25W...  Black</div>
                                <img src={Assured} alt="Assured" className='my-2' width={100} />
                                <p class="text-success des">
                                    <b>2% off</b>
                                    <del class="text-dark"> ₹ 3600</del>
                                    <span class="text-dark"> ₹ 249</span>
                                </p>
                            </div>
                        </Col>
                    </Row>
            ...
            <div className="product-det">
                <Container>
                    ...
                    <div className="img-container card">
                        <img className='mb-sm-5 mb-3' src={Charger} alt="WonderFull" />
                    </div>
                </Container>
            </div>
...
export default ChargerProductDet