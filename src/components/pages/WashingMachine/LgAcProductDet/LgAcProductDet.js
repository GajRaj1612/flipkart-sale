...
import LgAc from '../../../../assets/images/product-details/ac.jpg'
...
import AC1 from '../../../../assets/images/product-details/lgac_1.jpg'
import AC2 from '../../../../assets/images/product-details/lgac.jpg'
import AC3 from '../../../../assets/images/product-details/lgac_2.jpg'
import AC4 from '../../../../assets/images/product-details/lgac_3.jpg'
import { Link } from 'react-router-dom'

const LgAcProductDet = () => {
                            ...
                            <Col className='col-lg-4 col-md-6 col-sm-6'>
                                ...
                                >
                                    <div className='big-img-slider'>
                                        <img src={LgAc} alt="Iphone" height={450} width={"100%"} />
                                    </div>
                            ...
                            <Col>
                                ...
                                >
                                    <div className='small-img'>
                                        <img src={LgAc} alt="Iphone" width={40} />
                                    </div>
            ...
            <div className="product-select">
                <Container>
                    <Row className='product-des'>
                        <Col >
                            <div className='card'>
                                <div class="product-title"> LG 1.5 Ton 4 Star AI...  Deafult</div>
                                <img src={Assured} alt="Assured" className='my-2' width={100} />
                                <p class="text-success des">
                                    <b>2% off</b>
                                    <del class="text-dark"> ₹ 35000</del>
            ...
            <div className="product-det">
                <Container>
                    ...
                    <div className="img-container card">
                        <img className='mb-sm-5 mb-3' src={AC2} alt="Ahuge" />
                        <img className='mb-sm-5 mb-3' src={AC3} alt="Water" />
                        <img className='mb-sm-5 mb-3' src={AC4} alt="Crash" />
                        <img className='mb-sm-5 mb-3' src={AC1} alt="WonderFull" />
                    </div>
                </Container>
            </div>
